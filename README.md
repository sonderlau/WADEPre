...
We use Vertically Integrated Liquid (VIL) mosaics in SEVIR for benchmarking precipitation nowcasting, predicting the finest VIL inst to 6*10 minutes given 6*10 minutes of context VIL, and resizing the spatial resolution to 128. The resolution is thin `6×128×128 → 6×128×128`.
